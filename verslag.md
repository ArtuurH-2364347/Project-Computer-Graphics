...
## Modellen/textures
Voor de textures en models hebben we online models gedownload en ingeladen in het project. Dat inladen gebeurt via de stbi_image library.
...
## Interactie
In de rechterbovenhoek van het scherm wordt er een hotkey legende getoond, hier kunnen de verschillende vormen van interactie en filters getoggled. In de first/third person cam kan de autosnelheid worden aangepast. Door op Z/W, S, SHIFT en SPACE te drukken wordt de auto versneld, vertraagd, in achteruit gezet en gestopt. Daarnaast is er ook nog interactie in de vorm van picking
