...
## Animatie
De auto rijdt over de beziercurve met een constante snelheid. Dit gaat door de lengte van de beziercurve te bepalen en er dan duizend punten erop te zetten die even ver van elkaar afliggen. 
Die "even ver" wordt niet bepaalt door de objectieve afstand tussen twee punten, maar door de afstand wanneer er over de curve geloopt wordt. Daardoor moet de auto niet versnellen om naar het volgend punt te gaan. 
Dit kan nog steeds uitgezet worden met "L", dit togglet de "legacy driving mode". Daarmee versnelt en vertraagt de auto. We hebben dit erin gelaten als feature omdat dan de auto op een "realistische" manier over de track zou rijden, zo lijkt de auto meer op een f1 piloot. 
Voor het stuur wordt via sampleCurvature() de kromming van de curve berekend, die geschaald wordt naar een stuurhoek tussen -180° en +180°. Die hoek wordt doorgegeven aan DrawCar(), die de wielen en het stuur draait op basis van die hoek. De wielrotatie zelf wordt bijgehouden via distanceTraveled, dat elke frame een eenheid omhoog gaat en ook meegegeven wordt aan DrawCar(). Zo roteren de wielen dus op een logische snelheid.
...
- Cinematic Cam: We hebben nog een extra camera toegevoegd die een soort cinematic view geeft van de auto. Dit lijkt op een helicopter die de auto schaduwt.
- Legacy driving: Zoals eerder vermeld in de animatie sectie is er een legacy driving modus. Deze modus zorgt ervoor dat de auto niet over een constante snelheid over de track beweegt.
